...
class GroovyC(val classpath: Seq[File],
  ...
  lazy val generateStubsClass =
    classLoader.loadClass("org.codehaus.groovy.ant.GenerateStubsTask")
  lazy val groovycClass =
    classLoader.loadClass("org.codehaus.groovy.ant.Groovyc")
  lazy val javacClass =
    classLoader.loadClass("org.apache.tools.ant.taskdefs.Javac")
  ...
  lazy val setLocationMethod =
    pathClass.getMethod("setLocation", classOf[java.io.File])

  lazy val setGroovycSrcdirMethod =
    groovycClass.getMethod("setSrcdir", pathClass)
  lazy val setGroovycStubdirMethod =
    groovycClass.getMethod("setStubdir", classOf[java.io.File])
  lazy val setGroovycDestdirMethod =
    groovycClass.getMethod("setDestdir", classOf[java.io.File])
  lazy val setGroovycProjectMethod =
    groovycClass.getMethod("setProject", projectClass)
  lazy val addGroovycConfiguredJavacMethod =
    groovycClass.getMethod("addConfiguredJavac", javacClass)
  lazy val setGroovycKeepStubsMethod =
    groovycClass.getMethod("setKeepStubs", java.lang.Boolean.TYPE)
  lazy val setGroovycVerboseMethod =
    groovycClass.getMethod("setVerbose", java.lang.Boolean.TYPE)
  ...
  def compile(): Unit = {
    ...
    try {
      ...
      addGroovycConfiguredJavacMethod.invoke(groovyc,
                                             javac.asInstanceOf[AnyRef])
